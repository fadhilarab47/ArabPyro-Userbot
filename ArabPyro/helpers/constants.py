...
class First:
    ALIVE = "`Menyala Abangku 🔥`"
    REPO = """
**Hey Mek**, __I am using__ ⛔️ **ArabPyro-Userbot** ⛔️

      __Thanks For Using me__

✣ **Versi Ubot :** `{}`
✣ **Group Support :** [SIARAB Support](t.me/SiArab_Support)
✣ **Channel Update :** [Arabc0de](t.me/Arabc0de)
✣ **Owner Repository :** [Si Arab](t.me/Arabnihnge)
✣ **Repo :** [ArabPyro-Userbot](https://github.com/fadhilarab47/ArabPyro-Userbot)"""
    CREATOR = 'Repo ini di Buat <a href="https://github.com/fadhilarab47/ArabPyro-Userbot">ARAB</a> Karena Gabut Abis NT.'
    MSG_ON = """
⛔️ **ArabPyro-Userbot Berhasil Di Aktifkan**
━━
➠ **Versi Ubot -** `{}`
