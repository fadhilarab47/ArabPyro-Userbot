...
from ArabPyro.helpers.parser import mention_html, mention_markdown
from ArabPyro.modules.help import *
...
async def kickdel_cmd(client: Client, message: Message):
    Man = await edit_or_reply(message, "<b>Lagi Ngapus Akun Hantu...</b>")
    ...
    await Man.edit(f"<b>Berhasil Mengeluarkan {len(values)} Akun Hantu(s)</b>")
