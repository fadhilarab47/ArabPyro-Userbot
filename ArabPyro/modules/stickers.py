...
from ArabPyro.helpers.tools import get_arg, get_text, resize_media
from ArabPyro.utils.tools import add_text_img, bash
...
async def kang(client: Client, message: Message):
    ...
    if replied and replied.media:
        if replied.photo:
            ...
            return
        media_ = await client.download_media(replied, file_name="ArabPyro/resources/")
    else:
