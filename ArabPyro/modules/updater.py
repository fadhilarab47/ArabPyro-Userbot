...
from ArabPyro.helpers.misc import HAPP, XCB
from ArabPyro.helpers.tools import get_arg
from ArabPyro.utils.misc import restart
from ArabPyro.utils.pastebin import PasteBin
from ArabPyro.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        try:
            ...
            pass
        await status.edit(
            "`ArabPyro-Userbot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
