...
from ArabPyro import StartTime
from ArabPyro.helpers.basic import edit_or_reply
from ArabPyro.helpers.constants import WWW
from ArabPyro.helpers.PyroHelpers import SpeedConvert
from ArabPyro.utils.tools import get_readable_time
...
async def pingme(client: Client, message: Message):
    ...
    await xx.edit(
        ...
        f"├• **piww** - `%sms`\n"
        f"├• **uptime -** `{uptime}` \n"
        f"└• **i`m :** {client.me.mention}" % (duration)
    )
